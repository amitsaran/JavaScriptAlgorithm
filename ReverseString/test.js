...
test('reverseString function is defined', () => {
  ...
  expect(typeof ReverseString.reverseString2).toEqual('function');
});
...
test('reverses string \'abcd\'', () => {
  ...
  expect(ReverseString.reverseString2('abcd')).toEqual('dcba');
});
...
test('reverses string \'123  abcd\'', () => {
  ...
  expect(ReverseString.reverseString2('123  abcd')).toEqual('dcba  321');
});